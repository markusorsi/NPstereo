...
def main():
    for seed in seeds:
        for model_key in model_keys:
            ...
            canonical_src = os.path.join(opennmt_base_dir, f"seed-{seed}", "npstereo", "src-test.txt")
            canonical_tgt = os.path.join(opennmt_base_dir, f"seed-{seed}", "npstereo", "tgt-test.txt")
            canonical_out_dir = os.path.join(predictions_base_dir, f"seed-{seed}", f"{model_key}-canonical-partial")
            ...
            randomized_src = os.path.join(opennmt_base_dir, f"seed-{seed}", "ncnpstereo", "src-test.txt")
            randomized_tgt = os.path.join(opennmt_base_dir, f"seed-{seed}", "ncnpstereo", "tgt-test.txt")
            randomized_out_dir = os.path.join(predictions_base_dir, f"seed-{seed}", f"{model_key}-randomized-partial")
